minetest.register_entity("lucky_weapons:grenade_entity", {
	physical = false,
	timer = 0,
	visual = "cube",
...
minetest.register_tool("lucky_weapons:grenade", {
	description = "Grenade",
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pos and dir then
			pos.y = pos.y + 1.5
			local obj = minetest.add_entity(pos, "lucky_weapons:grenade_entity")
			if obj then

...
lucky_block:add_blocks({
	...
	{"nod", "default:chest", 0, {
		...
		{name = "lucky_drops:staff_magic", max = 3},
...
--Statues mod
if minetest.get_modpath("statues") then
	lucky_block:add_blocks({
		{"dro", {"statues:weeping"}, 1},
		{"dro", {"statues:evilcloack"}, 5},
		{"dro", {"statues:goodcloack"}, 5},
		{"dro", {"statues:goldarmor"}, 5},
		{"dro", {"statues:oldcoder", "statues:fishywet"}, 5},
		{"dro", {"statues:genshin"}, 1},
		{"dro", {"statues:hobbitpower", "statues:thomass", "statues:clanmaster"}, 5},
		{"dro", {"statues:evilfire"}, 5},
		{"dro", {"statues:stormtroop", "statues:stormtrooper"}, 5},
		{"dro", {"statues:oldcoder", "statues:fishywet", "statues:genshin", "statues:clanmaster", "statues:hobbitpower", "statues:thomass"}, 30},
		{"dro", {"statues:weeping", "statues:evilcloak", "statues:goldarmor"}, 5},
		{"dro", {"statues:shadychar"}, 5},
		{"dro", {"statues:witchking", "statues:flowerbluedress"}, 5},
	})
end
-- Lucky Drops mod
if minetest.get_modpath("lucky_drops") then
	lucky_block:add_blocks({
		{"dro", {"lucky_drops:horse"}, 1},
		{"nod", "default:dirt", 1},
		{"dro", {"lucky_drops:coin_gold"}, 5},
		{"dro", {"lucky_drops:shovel"}, 1},
		{"dro", {"lucky_drops:emerald"}, 5},
		{"nod", "lucky_drops:compact_diamond_block", 0},
		{"tro", "default:diamondblock"},
		{"nod", "default:diamondblock", 1},
		{"dro", {"lucky_drops:emerald", "lucky_drops:coin_blue"}, 5},
		{"dro", {"lucky_drops:coin_green"}, 1},
		{"nod", "default:goldblock", 0},
		{"dro", {"lucky_drops:coin_black", "lucky_drops:coin_gold", "lucky_drops:coin_fire"}, 5},
	})
end
-- Lucky Weapons mod
if minetest.get_modpath("lucky_weapons") then
	lucky_block:add_blocks({
		{"dro", {"lucky_weapons:staff_diamond"}, 1},
		{"dro", {"lucky_weapons:battleaxe_mese"}, 1},
		{"dro", {"lucky_weapons:magic_apple"}, 25},
		{"dro", {"lucky_weapons:gold_dagger"}, 1},
		{"dro", {"lucky_weapons:sword_of_chaos"}, 1},
		{"dro", {"lucky_weapons:destroyer"}, 1},
		{"dro", {"lucky_weapons:firebrand"}, 1},
		{"dro", {"lucky_weapons:galvorn_spear", "lucky_weapons:steel_dagger"}, 1},
		{"dro", {"lucky_weapons:wood_warhammer"}, 1},
	})
end
...
-- atomic_nuke mod
if minetest.get_modpath("atomic_nuke") then
local a = "atomic_nuke:atomic_tnt"
local h = "atomic_nuke:halt_tnt"
local d = "atomic_nuke:diabolic_tnt"
lucky_block:add_blocks({
	{"dro", {"atomic_nuke:atomic_tnt"}, 5, true},
	{"fal", {a, a, a, a, a}, 1, true, 4},
	{"spw", "atomic_nuke:atomic_tnt", 3},
	{"dro", {"atomic_nuke:halt_tnt"}, 5, true},
	{"fal", {h, h, h, h, h}, 1, true, 4},
	{"spw", "atomic_nuke:halt__tnt", 3},
	{"dro", {"atomic_nuke:diabolic_tnt"}, 5, true},
	{"fal", {d, d, d, d, d}, 1, true, 4},
	{"spw", "atomic_nuke:diabolic_tnt", 3},
})
end

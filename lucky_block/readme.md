luckyblocks ar blocks that when broken have a completly random effect, it can transform into another block, drop cool items, blow up, or spawn spawn enemies/npc's
